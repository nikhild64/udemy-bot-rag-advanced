      ...
      <main className="flex-1 container mx-auto px-4 py-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-2xl mt-20 flex flex-col items-center justify-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="text-center space-y-4">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Ask anything about the Chai Code <a href="https://www.udemy.com/course/complete-mobile-developer-course-with-ai-projects" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Expo Mobile Dev Course</a>.</h1>
