...
export function Logo({ className, iconOnly = false, size = 'md' }: LogoProps) {
  ...
  return (
    <div className={cn('flex items-center gap-2 font-bold text-foreground shrink-0', className)}>
      <div className={cn('flex items-center justify-center shrink-0', sizeMap[size])}>
        <div style={{ transform: 'rotate(3.62886deg)' }} className="w-full h-full">
          <svg
            viewBox="0 0 2000 2000"
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true"
            className="w-full h-full fill-[#B0B0B0] stroke-[#B0B0B0] dark:fill-[#ffffff] dark:stroke-[#ffffff]"
          >
            <path
              ...
              fill="#FF7D0C"
              style={{ transform: 'translateY(-4.94929px) scaleX(1.0198)', transformOrigin: '50% 50%', transformBox: 'fill-box' }}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              ...
              fill="#FE9332"
              style={{ transform: 'translateY(0.577542px) scaleX(1.00385)', transformOrigin: '50% 50%', transformBox: 'fill-box' }}
            />
      ...
      {!iconOnly && (
        <span className={cn('font-onest font-medium tracking-tight', textSizeMap[size])}>ChaibookLM</span>
      )}
    </div>
  );
}
